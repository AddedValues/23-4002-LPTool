...
class GdxWrapper():
    ...
    # ----------------------------------------------------------------------------------------------------------
    def __init__(self, name, pathFile, logger: logging.Logger):
        """Initializes instance by a user-given name and a file path."""
        ...
        self.logger.info(f'Opening gdx file: {pathFile}')
        self.db = self.ws.add_database_from_gdx(pathFile, database_name=name)
        self.logger.info('Opening gdx file succeeded !')
        self.sets = {}
        self.parms = {}
        self.vars = {}
        self.eqns = {}
