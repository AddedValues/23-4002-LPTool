...
class Lpbase():
    ...
    @staticmethod
    def initLogger(logName: str, logfileName: str) -> logging.Logger:
    ...
    def getLogger() -> logging.Logger:
        if Lpbase._logger is None:
            Lpbase._logger = Lpbase.initLogger(f"{__name__}", f"{__name__}")
    ...
    #     self.getLogger = Lpbase.initLogger(Lpbase.logName, f"{self._name}")
    #     return
